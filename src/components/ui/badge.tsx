...
export function InternalCode({ children }: { children: ReactNode }) {
  return (
    <span className="inline-flex rounded-[6px] bg-app-subtle px-1.5 py-0.5 font-mono text-[13px] font-semibold text-app-primary">
      {children}
    </span>
  );
}
